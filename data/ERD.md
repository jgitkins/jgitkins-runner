...
erDiagram
    ...
    RUNNER ||--o{ RUNNER_CONFIG_FILE : "stores runner artifacts"
```
...
- **RUNNER_CONFIG_FILE**: 러너 이미지, 플러그인 목록 등 텍스트 기반 실행 자산을 파일 단위로 저장합니다. 러너는 활성화 시 해당 내용을 내려받아 로컬 볼륨 없이도 환경을 구성할 수 있습니다.
